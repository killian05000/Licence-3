...
#line 133 "analyseur_syntaxique.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "SI", "$accept", "programme", YY_NULLPTR
};
#endif
...
#line 1195 "analyseur_syntaxique.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 23 "analyseur_syntaxique.y" /* yacc.c:1906  */
